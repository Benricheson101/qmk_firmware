...
enum planck_layers { _QWERTY, _COLEMAKDH, _DVORAK, _LOWER, _RAISE, _PLOVER, _ADJUST };

enum planck_keycodes { QWERTY = SAFE_RANGE, COLEMAKDH, DVORAK, PLOVER, BACKLIT, EXT_PLV };
...
[_QWERTY] = LAYOUT_planck_grid(
    ...
    // KC_LCTL, KC_LCTL, KC_LALT, KC_LGUI, KC_SPC, LOWER, RAISE, KC_SPC,  KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
...
[_ADJUST] = LAYOUT_planck_grid(
    ...
    _______, EE_CLR,  MU_NEXT, AU_ON,   AU_OFF,  AG_NORM, AG_SWAP, QWERTY,  COLEMAKDH, DVORAK,  PLOVER,  _______,
